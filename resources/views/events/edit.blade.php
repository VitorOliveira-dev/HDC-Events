...
<div id="events-create-container" class="col-md-6 offset-md-3">
    ...
    <form action="/events/update/{{$event->id}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="date" name="date" id="date" class="form-control" placeholder="Data do evento" value="{{$event->date->format('Y-m-d')}}">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <label for="items">Adicione itens de sua infraestrutura: </label>
            <div class="form-group">
